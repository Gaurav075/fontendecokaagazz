...
const Header = () => {
  ...
  return (
    <header className="py-2 px-8 md:px-16 flex justify-between items-center bg-[url('/bg1.png')] bg-cover bg-center bg-no-repeat relative border-b border-gray-200 relative">
      {/* Logo */}
