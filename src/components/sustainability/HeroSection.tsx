...
const HeroSection = () => (
  <div className="relative h-[360px] md:h-[420px] w-full font-serif overflow-hidden">
    ...
    <div className="absolute inset-0 flex items-center justify-center px-4 sm:px-8">
      <h1 className="text-white text-center font-bold leading-tight drop-shadow-md whitespace-nowrap text-[20px] sm:text-[24px] md:text-[30px] lg:text-[36px] xl:text-[42px]">
